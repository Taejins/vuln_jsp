...
<%
	...
	if(request.getMethod().equals("POST")){
		...
		try{
			...
			String sql = "select * from jsp_usr where email = '" + email + "' and pw = '" + pw+"'";
			...
			if (rs.next()) {
				...
				page_session.setAttribute("usr_email", rs.getString("email")); 
				//쿠키
				Cookie cookie = new Cookie("admin", rs.getString("admin"));
